...
function canInsertObject() {
	...
	if( retVal )
	{
		retVal = Spry.DesignTime.Editing.Utils.canInsertWidget(dom, "Spry.Widget.ValidationTextarea");
	}
...
function insertObject() {
  ...
  var cmdFile = dreamweaver.getConfigurationPath() + "/Commands/SpryValidationTextarea.htm";
  var cmdDOM = dreamweaver.getDocumentDOM(cmdFile);
  dreamweaver.popupCommand("SpryValidationTextarea.htm");
