...
function canInsertObject() {
  ...
  if( retVal )
  {
    retVal = Spry.DesignTime.Editing.Utils.canInsertWidget(dom, "Spry.Widget.ValidationPassword");
  }
...
function insertObject() {
  ...
  var cmdFile = dreamweaver.getConfigurationPath() + "/Commands/SpryValidationPassword.htm";
  var cmdDOM = dreamweaver.getDocumentDOM(cmdFile);
  dreamweaver.popupCommand("SpryValidationPassword.htm");
