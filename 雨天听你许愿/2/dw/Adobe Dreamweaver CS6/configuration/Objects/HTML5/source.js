...
function objectTag() {
  ...
  var srcFld;
  if (gDialogShown) {
    mediaFld = document.MainForm.mediaFld.value;
	typeFld = document.MainForm.typeFld.value;
    srcFld = document.MainForm.srcFld.value;	
  } 
  if (!srcFld);
  var rtnString = '<source src="' + srcFld + '" media="' + mediaFld + '" type="' + typeFld + '"' + '>';
