...
function createMasterDetailSet(paramObj)
{
  ...
  var tables = FieldTypes.getTablesFromSQL(paramObj.ConnectionName, paramObj.SQLStatement);
  var fieldObj = FieldTypes.getFieldObj(paramObj.ConnectionName, tables, paramObj.UniqueIDField);
  if (fieldObj != null)
  {
	fieldObj = [fieldObj];
  }
  var cfParameter = FieldTypes.buildCFParameter("#URL.recordID#", paramObj.UniqueIDField, fieldObj);
  var conditionStr = paramObj.UniqueIDField + " = " + cfParameter;
  ...
  // Add URL.recordID cfparameter to detail page
  var tempObj = new Object();
  tempObj.ParamName = "URL.recordID";
  tempObj.Default = 1;
  extPart.queueDocEdits("","CFParam_main", tempObj, null);
